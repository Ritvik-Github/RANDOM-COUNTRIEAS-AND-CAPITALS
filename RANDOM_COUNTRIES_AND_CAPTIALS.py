...
btn = Button(root, text = " Display Country And City Name ", command = country_city_list , bg ="Blue", fg ="White")
...
btn2 = Button(root, text = " Display Country And City Name Randomly", command = random_country_city,bg ="Blue", fg ="White")
